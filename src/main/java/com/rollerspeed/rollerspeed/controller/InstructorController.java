...
public class InstructorController {
    ...
    @Operation(summary = "Actualizar un instructor", description = "Actualiza la información de un instructor existente")
    @PostMapping("/edit/{id}")
    ...
    @Operation(summary = "Eliminar un instructor", description = "Elimina un instructor del sistema")
